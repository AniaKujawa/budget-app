var budgetController = (function() {
    ...
    var calculateTotal = function(type) {
      ...
      localStorage.setItem(`totals[${type}]`, sum);
    };

    var data = {
      allItems: {
        exp: localStorage.getItem('exp') ? JSON.parse(localStorage.getItem('exp')) : [],
        inc: localStorage.getItem('inc') ? JSON.parse(localStorage.getItem('inc')) : [],
      },
      totals:{
        exp: localStorage.getItem('totals[exp]') || 0,
        inc: localStorage.getItem('totals[inc]') || 0,
      },
      budget: localStorage.getItem('budget') || 0,
      percentage: localStorage.getItem('percentage') || -1
    };
    ...
    deleteItem: function(type, id) {
      ...
      if (index !== -1) {
        ...
        localStorage.setItem(`${type}`, data.allItems[`${type}`]);
      }
...
var UIController = (function() {
  ...
  return {
    ...
    addListItem: function(obj, type) {
      ...
      //Replacing the placehoder text with some actual data
...
var controller = (function(budgetCtrl, UICtrl) {
  ...
  var updatePercentages = function() {
    //Calculaiting percentages
    budgetCtrl.calculatePercentages();
    //Reading percentages from the budget controller
  ...
  var ctrlAddItem = function() {
    ...
    //Getting the field input data
     ...
     if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
       ...
       //Clearing the fields
       UICtrl.clearFields();
       //Calcuating and updating budget
       updateBudget();
     };
  };
  ...
  return {
    init: function() {
      ...
      console.log(budget);
      if (budget.budget) {
        budget.allExp.forEach(ex => UICtrl.addListItem(ex, 'exp'));
        budget.allInc.forEach(inc => UICtrl.addListItem(inc, 'inc'));
      }
      setupEventListeners();
    }
  }
